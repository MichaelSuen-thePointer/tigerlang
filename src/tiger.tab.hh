...
#line 58 "tiger.tab.hh" // lalr1.cc:377
...
#line 5 "tiger.yy" // lalr1.cc:377
namespace tiger {
#line 135 "tiger.tab.hh" // lalr1.cc:377
  ...
  public:
    ...
    union union_type
    {
      ...
      // for
      char dummy4[sizeof(For*)];

      // function-declaration
      char dummy5[sizeof(FunctionDeclaration*)];

      // if-then
      char dummy6[sizeof(IfThen*)];

      // if-then-else
      char dummy7[sizeof(IfThenElse*)];

      // let-expression
      char dummy8[sizeof(Let*)];

      // record-type
      char dummy9[sizeof(RecordType*)];

      // type
      char dummy10[sizeof(Type*)];

      // type-declaration
      char dummy11[sizeof(TypeDeclaration*)];

      // variable-declaration
      char dummy12[sizeof(VariableDeclaration*)];

      // while
      char dummy13[sizeof(While*)];
      ...
      char dummy16[sizeof(std::vector<Declaration*>)];
      ...
      char dummy18[sizeof(std::vector<FieldDeclaration>)];

      // comma-separated-parameter
      // nonempty-comma-separated-parameter
      char dummy19[sizeof(std::vector<FunctionParameter>)];

      // comma-separated-record-field
      // nonempty-comma-separated-record-field
      char dummy20[sizeof(std::vector<std::tuple<std::string, Expression*, tiger::location>>)];
};
  ...
  basic_symbol (typename Base::kind_type t, const For* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const FunctionDeclaration* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const IfThen* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const IfThenElse* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const Let* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const RecordType* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const Type* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const TypeDeclaration* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const VariableDeclaration* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const While* v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const std::vector<FieldDeclaration> v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const std::vector<FunctionParameter> v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const std::vector<std::tuple<std::string, Expression*, tiger::location>> v, const location_type& l);
    ...
    TigerParser (tiger::TigerScanner& scanner_yyarg, std::unique_ptr<Program>& prog_yyarg);
    virtual ~TigerParser ();
...
#line 985 "tiger.tab.hh" // lalr1.cc:377
