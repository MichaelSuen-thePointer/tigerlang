...
namespace tiger {
    ...
    VariableDeclaration::VariableDeclaration(std::string id, std::string typeID, Expression *exp)
            : IdentifierTypeDeclaration(std::move(id), std::move(typeID)), _initializer(exp) {
    }
    ...
    FunctionDeclaration::FunctionDeclaration(std::string identifier, std::vector<FunctionParameter> &params,
                                             std::string returnType, Expression *body)
            : _identifier(std::move(identifier)), _parameters(std::move(params)), _returnType(std::move(returnType)),
              _body(body) {
    }
    ...
    FieldInitializer::FieldInitializer(std::string id, Expression *initializer)
            : _identifier(std::move(id)), _initializer(initializer) {
    }
