...
FunctionDeclaration::FunctionDeclaration(std::string identifier, std::vector<FunctionParameter>& params, std::string returnType, Expression* body, bool isBuiltin)
...
const bool& FunctionDeclaration::isBuiltin() const
{
    return _isBuiltin;
}
